...
// stampa publication per ogni formato bitex (author, url, title, journal, volume, pages, number, pubstate, issn) editor non incluso nello script
var defaultTemplate = "<div class=\"bibtex_template\" style=\"clear:left;\">" +
    "<ul ><li>"+
    "<div class=\"if author\" style=\"font-weight: bold; font-size:11px;\">\n" +
    "</span>\n  <span class=\"author\"></span>\n" +

    "<span class=\"if url\" style=\"margin-left: 20px\">\n" +
    "<a class=\"url\" style=\"color:#0000cc; font-size:10px\">(view online)</a>\n" +
    "</span>\n</div>\n<div style=\"margin-left: 10px; margin-bottom:5px;\">\n" +

    "<div class=\"if title\" style=\"font-weight: bold;color:black;font-size:15px;clear:left;\">\n" +
    "</span>\n<span class=\"title\"></span>\n</div>" +  

    "<div class=\"if journal\" style=\"float:left;\">\n" +
    "</span>  <span class=\"journal\"></span>,</div>" +

    "<div class=\"if volume\" style=\"float:left;\">" +
    "<span class=\"volume\"></span>,</div>" +

    "<div class=\"if pages\" style=\"float:left;\">" +
    "<span class=\"pages\"></span>,</div>" +

     "<div class=\"if number\" style=\"float:left;\">" +
    "<span class=\"number\"></span>,</div>" +

    "<div class=\"if pubstate\" style=\"float:left;\">" +
    "<span class=\"pubstate\"></span>,</div>" +


    "<div class=\"if issn\" style=\"float:left;\">" +
    "<span class=\"issn\"></span></div>" +"</li></ul>\n\n\n";
